...
> **类型**：plan · **状态**：archived  
> **现行规范**：[../../specs/SCROLL_VIEWPORT.md](../../specs/SCROLL_VIEWPORT.md)

本文档汇总 BindTTY **Milestone 7** 的目标、分层设计、稳定接口契约、实现阶段与验收标准。
...
- [TUI_IMPLEMENTATION_PLAN.md](../../architecture/ROADMAP.md) — 全项目里程碑与优先级
- [DESIGN.md](../../architecture/DESIGN.md) — 视图树与 binding 模型
- [LAYOUT.md](../../packages/LAYOUT.md) — LayoutNode、overflow 预留
- [RENDERER.md](../../packages/RENDERER.md) — Frame、viewport 裁剪、paint 规则
- [VNODE.md](../../packages/VNODE.md) — intrinsic tag 扩展点
- [INTERACTION.md](../../packages/INTERACTION.md) — focus 与 key dispatch
- [WIDGETS.md](../../packages/WIDGETS.md) — 高层控件边界
- [APP.md](../../packages/APP.md) — createApp 编排链
- [E2E_TESTING.md](../../testing/E2E.md) — 测试策略
...
- 水平滚动（可预留 API，实现可后置）
- 鼠标滚轮、触摸
- margin / gap / flex grow 等高级 layout（见 [TUI_IMPLEMENTATION_PLAN.md](../../architecture/ROADMAP.md) 后续项）
- Unicode 宽字符 / emoji display-width 测量（已由 [DISPLAY_WIDTH.md](../../specs/DISPLAY_WIDTH.md) 在 text/layout/renderer 落地；ScrollView 垂直滚动无额外 wide 逻辑）
...
遵循 [E2E_TESTING.md](../../testing/E2E.md)：**细节在 mock，真实性在 PTY smoke**。
...
- [x] [TUI_IMPLEMENTATION_PLAN.md](../../architecture/ROADMAP.md) — M7 勾选子项
- [x] [LAYOUT.md](../../packages/LAYOUT.md) — overflow/scroll 从「后续」改为已实现
- [x] [RENDERER.md](../../packages/RENDERER.md) — clip/scroll paint 规则
- [x] [WIDGETS.md](./WIDGETS.md) — ScrollView / List API
- [x] [VNODE.md](../../packages/VNODE.md) — box 新 layout props schema
- [x] [JSX_RUNTIME.md](./JSX_RUNTIME.md) — box TSX props 增量
- [x] [E2E_TESTING.md](../../testing/E2E.md) — 新增场景列表
