...
- **概述**：[§1 主链路](#1-主链路) · [§2 包职责](#2-包职责) · [§3 设计目标](#3-设计目标) · [§4 核心原则](#4-核心原则)
- **Template 节点**：[§5 节点集合](#5-template-节点集合) · [§6 Empty](#6-emptytemplate) · [§7 Element](#7-elementtemplate) · [§8 Container/Leaf](#8-为什么-elementtemplate-不区分-container-leaf) · [§9 IntrinsicTag](#9-intrinsicelementtag) · [§10 Props](#10-templateprops)
- **绑定与 children**：[§11 BindingValue](#11-bindingvalue) · [§12 文本](#12-文本设计) · [§13 children](#13-children-规则)
- **控制流 Template**：[§14 Fragment](#14-fragmenttemplate) · [§15 Component](#15-componenttemplate) · [§16 Show](#16-showtemplate) · [§17 For](#17-fortemplate)
- **Schema 与 Normalize**：[§18 Element Schema](#18-element-schema) · [§19 JSX 类型](#19-jsx-类型约束) · [§20 TSX Normalize](#20-tsx-normalize-规则) · [§21 示例](#21-template-示例)
- **MountedNode 基础**：[§22 定位](#22-mountednode-的定位) · [§23 为什么需要](#23-为什么需要-mountednode) · [§24 与 Template 关系](#24-mountednode-和-template-的关系) · [§25 核心职责](#25-mountednode-的核心职责) · [§26 节点类型](#26-mountednode-的节点类型)
- **ElementDefinition 与职责**：[§27 ElementDefinition](#27-elementdefinition-基础控件能力的来源) · [§28 text 渲染](#28-text-的渲染在哪里处理) · [§29 input 交互](#29-input-的交互在哪里处理) · [§30 show/for](#30-show-for-的职责) · [§31 Layout/Paint/Input](#31-layout-paint-input-与-mountednode-的关系)
- **更新与对比**：[§32 Dirty](#32-dirty-更新模型) · [§33 dispose](#33-dispose-机制) · [§34 整体理解](#34-推荐的整体理解) · [§35 vs React/DOM](#35-和-react-dom-的区别) · [§36 边界](#36-template-与-mountednode-边界) · [§37 类型草案](#37-完整类型草案) · [§38 推荐写法](#38-推荐用户写法) · [§39 总结](#39-总结)
