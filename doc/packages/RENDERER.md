...
| § | 章节 | § | 章节 |
| --- | --- | --- | --- |
| [1](#_1-目标) | 目标 | [8](#_8-样式-props) | 样式 Props |
| [2](#_2-包位置) | 包位置 | [9](#_9-diff-与-ansi-patch) | Diff/ANSI |
| [3](#_3-输入与输出) | 输入输出 | [10](#_10-dirty-模型对接) | Dirty |
| [4](#_4-与其它模块的接口调用) | 模块接口 | [11](#_11-terminal-边界) | Terminal |
| [5](#_5-frame-模型) | Frame | [12](#_12-mvp-落地阶段) | MVP 落地 |
| [6](#_6-paint-规则) | Paint | [13](#_13-测试用例建议) | 测试 |
| [7](#_7-实现判定规则) | 判定规则 | [14](#_14-当前结论) | 当前结论 |
