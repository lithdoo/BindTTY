...
export const defaultFixedKeymap: readonly FixedKeymapEntry[] = [
  ...
  { name: "f1", input: "", sequences: ["\x1bOP", "\x1b[11~", "\x1b[[A", "\x00;"] },
  { name: "f2", input: "", sequences: ["\x1bOQ", "\x1b[12~", "\x1b[[B", "\x00<"] },
  { name: "f3", input: "", sequences: ["\x1bOR", "\x1b[13~", "\x1b[[C", "\x00="] },
  { name: "f4", input: "", sequences: ["\x1bOS", "\x1b[14~", "\x1b[[D", "\x00>"] },
  { name: "f5", input: "", sequences: ["\x1b[15~", "\x1b[[E", "\x00?"] },
